...
const Navbar = () => {
  ...
  return (
    <div className="w-full">
      {/* Navbar */}
      <div className=" z-[10000]  border-b-[2px] border-solid dark:border-black rounded-b-[15px] bg-[#2e1563] dark:bg-[#ffffff]  md:text-white dark:text-black flex justify-between py-[17px] items-center w-[100%] border-white px-[25px] md:px-[40px]  m-auto ">
        <div>
